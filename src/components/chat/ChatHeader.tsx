    ...
    <div className="flex items-center justify-between border-b border-border/70 bg-surface/90 px-4 py-3 backdrop-blur-md">
      ...
      <div className="flex items-center gap-1">
        <button
          type="button"
          onClick={clearChat}
          className="rounded-lg p-1.5 text-muted-foreground hover:bg-surface-muted hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring transition-colors"
